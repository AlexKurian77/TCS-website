...
const Footer = () => {
  return (
    <div className="relative group duration-500 group relative text-gray-50
    h-full w-full rounded-2xl hover:duration-700 duration-700">
      ...
      <div className="absolute bg-white -bottom-24 w-full p-8 flex flex-col gap-1 group-hover:-bottom-0 group-hover:duration-600 duration-500">
        <div className="text-black font-bold text-l text-center" id="socials">
            <span>Instagram</span>
            <span>Youtube</span>
            <span>GitHub</span>
        </div>
